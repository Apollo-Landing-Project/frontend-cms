...
export default function NewsNewsForm({
    ...
    useEffect(() => {
        if (initialData) {
            reset({
                ...
                badge: initialData.newsNewsId?.badge || "",
                badge_en: initialData.newsNewsEn?.badge || "",
    ...
    const onSubmit = async (data: FormValues) => {
        ...
        try {
            ...
            toast.success(
                isEditMode ? "News updated!" : "News created!",
            );
            setTimeout(() => {
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <FormInput
                                    ...
                                    error={errors.badge}
                                    placeholder="Badge berita... (mis: Berita Terbaru)"
                                />
                                <FormInput
                                    label="Description"
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <FormInput
                                    ...
                                    placeholder="News badge... (e.g. Latest News)"
                                />
                                <FormInput
                                    label="Description"
